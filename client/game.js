document.addEventListener('DOMContentLoaded', () => {
    ...
    // Implementación de PollingConnection
    class PollingConnection {
        ...
        send(message) {
            ...
            switch (msg.type) {
                ...
                default:
                    console.warn('Tipo de mensaje no soportado:', msg.type);
                    return;
            }
            ...
            if (endpoint) {
                fetch(endpoint, {
                    ...
                    showNotification('Error al enviar acción', true);
                });
            }
        }
