...
class Tablero:
    ...
    def mostrar_cartas_columna(self, ventana, nombre_columna):
        ...
        # Crear superficie para el fondo oscuro semitransparente
        ...
        while esperando:
            ...
            # Crear superficie transparente para la ventana
            ventana_emergente = pygame.Surface(
                (ancho_ventana, alto_ventana), pygame.SRCALPHA)

            # Marco y fondo de la ventana emergente
            ...
            pygame.draw.rect(ventana_emergente, (120, 120, 120, 200),
                             (0, 0, ancho_ventana, alto_ventana), 3, border_radius=10)
            ...
            # Crear superficie para el contenido (transparente)
